...
namespace Xels.Bitcoin.Features.Wallet.Tests
{
    public class WalletSyncManagerTest : LogsTestBase
    {
        ...
        {
            this.SetupMockObjects(new ChainIndexer(KnownNetworks.XelsMain));
        }
        ...
        */
        ...
        {
            this.SetupMockObjects(WalletTestsHelpers.GenerateChainWithHeight(5, KnownNetworks.XelsMain));
        ...
        {
            this.SetupMockObjects(WalletTestsHelpers.GenerateChainWithHeight(3, KnownNetworks.XelsMain));
        ...
        {
            this.SetupMockObjects(WalletTestsHelpers.GenerateChainWithHeight(1, KnownNetworks.XelsMain));
