...
namespace Xels.Bitcoin.Features.Wallet.Tests
{
    public class WalletManagerTest : LogsTestBase, IClassFixture<WalletFixture>
    {
        ...
        public void CreateWalletWithoutPassphraseOrMnemonicCreatesWalletUsingPassword()
        {
            ...
            IWalletRepository walletRepository = new SQLiteWalletRepository(this.LoggerFactory.Object, dataFolder, KnownNetworks.XelsMain, DateTimeProvider.Default, new ScriptAddressReader());
            ...
            Assert.Equal(KnownNetworks.XelsMain, actualWallet.Network);

            Assert.Equal(1, actualWallet.AccountsRoot.Count);

            for (int i = 0; i < actualWallet.AccountsRoot.Count; i++)
            {
                Assert.Equal(CoinType.Xels, actualWallet.AccountsRoot.ElementAt(i).CoinType);
        ...
        public void CreateWalletWithPasswordAndPassphraseCreatesWalletUsingPasswordAndPassphrase()
        {
            ...
            var network = KnownNetworks.XelsMain;
        ...
        public void RecoverWalletWithEqualInputAsExistingWalletRecoversWallet()
        {
            ...
            (Wallet wallet, Mnemonic mnemonic) deletedWallet;
            {
                ...
                IWalletRepository oldWalletRepository = new SQLiteWalletRepository(this.LoggerFactory.Object, oldDataFolder, KnownNetworks.XelsMain, DateTimeProvider.Default, new ScriptAddressReader());
                var oldWalletManager = new WalletManager(this.LoggerFactory.Object, KnownNetworks.XelsMain, chainIndexer, new WalletSettings(NodeSettings.Default(this.Network)),
        ...
        public void GetSpendableTransactionsReturnsTransactionsGivenBlockHeight()
        {
            ...
            WalletTestsHelpers.CreateUnspentTransactionsOfBlockHeights(account1.ExternalAddresses, KnownNetworks.XelsMain, 8, 9, 10);
            WalletTestsHelpers.CreateUnspentTransactionsOfBlockHeights(account1.InternalAddresses, KnownNetworks.XelsMain, 8, 9, 10);
            ...
            WalletTestsHelpers.CreateUnspentTransactionsOfBlockHeights(account2.ExternalAddresses, KnownNetworks.XelsMain, 1, 3, 5, 7, 9, 10);
            WalletTestsHelpers.CreateUnspentTransactionsOfBlockHeights(account2.InternalAddresses, KnownNetworks.XelsMain, 2, 4, 6, 8, 9, 10);
