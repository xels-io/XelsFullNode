...
namespace Xels.Features.FederatedPeg
{
    ...
    public sealed class FederatedPegSettings : IFederatedPegSettings
    {
        ...
        /// </summary>
        public const int XelsMainDepositStartBlock = 1_100_000;
        ...
        public FederatedPegSettings(NodeSettings nodeSettings)
        {
            ...
            this.CounterChainDepositStartBlock = configReader.GetOrDefault<int>(CounterChainDepositBlock, this.IsMainChain ? 1 : XelsMainDepositStartBlock);
