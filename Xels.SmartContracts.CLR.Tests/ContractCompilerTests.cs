...
namespace Xels.SmartContracts.CLR.Tests
{
    public class ContractCompilerTests
    {
        ...
        public void SmartContract_ReferenceResolver_HasCorrectAssemblies()
        {
            ...
            Assert.Contains(allowedAssemblies, a => a.GetName().Name == "Xels.SmartContracts");
            Assert.Contains(allowedAssemblies, a => a.GetName().Name == "System.Linq");
            Assert.Contains(allowedAssemblies, a => a.GetName().Name == "Xels.SmartContracts.Standards");
        }
