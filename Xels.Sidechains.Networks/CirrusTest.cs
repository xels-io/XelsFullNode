...
namespace Xels.Sidechains.Networks
{
    ...
    public class CirrusTest : PoANetwork
    {
        ...
        internal CirrusTest()
        {
            ...
            string coinbaseText = "https://github.com/xelsproject/XelsBitcoinFullNode/tree/master/src/Xels.CirrusD";
            ...
            {
                new DNSSeedData("cirrustest1.xelsplatform.com", "cirrustest1.xelsplatform.com")
