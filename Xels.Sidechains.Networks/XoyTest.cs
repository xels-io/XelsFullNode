...
namespace Xels.Sidechains.Networks
{
    ...
    /// </summary>
    public class XoyTest : PoANetwork
    {
        ...
        internal XoyTest()
        {
            ...
            string coinbaseText = "https://github.com/xelsproject/XelsBitcoinFullNode/tree/master/src/Xels.XoyD";
            ...
            {
                new DNSSeedData("xoytest1.xelsplatform.com", "xoytest1.xelsplatform.com")
