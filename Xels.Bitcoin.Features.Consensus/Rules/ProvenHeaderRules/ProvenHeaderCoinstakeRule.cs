...
namespace Xels.Bitcoin.Features.Consensus.Rules.ProvenHeaderRules
{
    /// <summary>
    ...
    /// <seealso cref="T:Xels.Bitcoin.Features.Consensus.Rules.ProvenHeaderRules.ProvenHeaderRuleBase" />
