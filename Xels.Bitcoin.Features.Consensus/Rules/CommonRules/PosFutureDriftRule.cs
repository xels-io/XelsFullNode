...
{
    /// <summary>
    /// A rule that will verify the block time drift is according to the PoS consensus rules for the <see cref="XelsMain"/> network (and its test networks).
    /// New networks must use the <see cref="PosFutureDriftRule"/>.
    /// </summary>
    public class XelsBugFixPosFutureDriftRule : PosFutureDriftRule
    {
        ...
        {
            // This is a specific Xels bug fix where the blockchain drifted 24 hour ahead as the protocol allowed that.
