...
namespace Xels.Bitcoin.Features.Consensus.Behaviors
{
    /// <summary>
    ...
    public class ProvenHeadersConsensusManagerBehavior : ConsensusManagerBehavior
    {
        ...
        /// Gateway are used internally by Xels to prevent network split during the transition from Headers to ProvenHeaders protocol.
