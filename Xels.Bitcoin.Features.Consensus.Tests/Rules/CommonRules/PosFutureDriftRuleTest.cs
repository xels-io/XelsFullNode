...
namespace Xels.Bitcoin.Features.Consensus.Tests.Rules.CommonRules
{
    public class PosFutureDriftRuleTest : TestPosConsensusRulesUnitTestBase
    {
        ...
        {
            long futureDriftTimestamp = (XelsBugFixPosFutureDriftRule.DriftingBugFixTimestamp - 100);
        ...
        public void RunAsync_HeaderTimestampSameAsFutureDriftLimit_WithoutReducedDrift_DoesNotThrowExceptionAsync()
        {
            ...
            this.consensusRules.RegisterRule<XelsBugFixPosFutureDriftRule>().Run(this.ruleContext);
        }
