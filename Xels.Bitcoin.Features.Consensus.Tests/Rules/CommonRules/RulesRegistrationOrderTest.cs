...
namespace Xels.Bitcoin.Features.Consensus.Tests.Rules.CommonRules
{
    public class ConsensusRulesRegistrationTest
    {
        ...
        [Fact]
        public void XelsConsensusRulesRegistrationTest()
        {
            Network network = new XelsTest();
            ...
            headerValidationRules[2].Should().BeOfType<XelsBugFixPosFutureDriftRule>();
            headerValidationRules[3].Should().BeOfType<CheckDifficultyPosRule>();
            headerValidationRules[4].Should().BeOfType<XelsHeaderVersionRule>();
