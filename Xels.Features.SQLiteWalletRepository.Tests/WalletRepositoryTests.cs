...
namespace Xels.Features.SQLiteWalletRepository.Tests
{
    ...
    public class WalletRepositoryTests
    {
        ...
        public WalletRepositoryTests(bool dbPerWallet = true)
        {
            ...
            this.network = KnownNetworks.XelsMain;


            //Configure this to point to your "XelsTest" root folder and wallet.
        ...
        private void CanProcessBlocks(bool mainChain, string[] walletNames)
        {
            using (var dataFolder = new TempDataFolder(this.GetType().Name))
            {
                var network = mainChain ? KnownNetworks.XelsMain : KnownNetworks.XelsTest;
