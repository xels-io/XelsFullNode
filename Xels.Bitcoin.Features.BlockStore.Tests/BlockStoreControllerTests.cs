...
namespace Xels.Bitcoin.Features.BlockStore.Tests
{
    public class BlockStoreControllerTests
    {
        ...
        public void Get_Block_When_Block_Is_Found_And_Requesting_JsonOuput()
        {
            ...
            store.Setup(c => c.GetBlockAsync(It.IsAny<uint256>()))
                .Returns(Task.FromResult(Block.Parse(BlockAsHex, KnownNetworks.XelsTest)));
        ...
        public void GetBlockCount_ReturnsHeightFromChainState()
        {
            ...
            ConcurrentChain chain = WalletTestsHelpers.GenerateChainWithHeight(3, KnownNetworks.XelsTest);
            ...
            var controller = new BlockStoreController(KnownNetworks.XelsTest, logger.Object, store.Object, chainState.Object, chain);
        ...
        private static (Mock<IBlockStore> store, BlockStoreController controller) GetControllerAndStore()
        {
            ...
            Block block = Block.Parse(BlockAsHex, KnownNetworks.XelsTest);
            chain.Setup(c => c.GetBlock(It.IsAny<uint256>())).Returns(new ChainedHeader(block.Header, block.Header.GetHash(), 1));

            var controller = new BlockStoreController(KnownNetworks.XelsTest, logger.Object, store.Object, chainState.Object, chain.Object);
