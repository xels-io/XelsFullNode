    ...
    public class BlockStoreControllerTests
    {
        ...
        public void Get_Block_When_Block_Is_Found_And_Requesting_JsonOuput()
        {
            ...
            store.Setup(c => c.GetBlock(It.IsAny<uint256>()))
                .Returns(Block.Parse(BlockAsHex, KnownNetworks.XelsTest.Consensus.ConsensusFactory));
        ...
        public void Get_Block_When_Block_Is_Found_And_Requesting_RawOuput()
        {
            ...
            response.Should().BeOfType<JsonResult>();
            var result = (JsonResult)response;
            ((Block)(result.Value)).ToHex(KnownNetworks.XelsTest).Should().Be(BlockAsHex);
        }
        ...
        public void GetBlockCount_ReturnsHeightFromChainState()
        {
            ...
            ChainIndexer chainIndexer = WalletTestsHelpers.GenerateChainWithHeight(3, KnownNetworks.XelsTest);
            ...
            var controller = new BlockStoreController(KnownNetworks.XelsTest, logger.Object, store.Object, chainState.Object, chainIndexer, addressIndexer.Object);
        ...
        private static (Mock<IBlockStore> store, BlockStoreController controller) GetControllerAndStore()
        {
            ...
            Block block = Block.Parse(BlockAsHex, KnownNetworks.XelsTest.Consensus.ConsensusFactory);
            ...
            var controller = new BlockStoreController(KnownNetworks.XelsTest, logger.Object, store.Object, chainState.Object, chain.Object, addressIndexer.Object);
