...
namespace Xels.Bitcoin.Features.BlockStore.Tests
{
    public class BlockStoreTests
    {
        ...
        public BlockStoreTests()
        {
            ...
            this.listOfSavedBlocks.Add(uint256.One, Block.Parse(this.testBlockHex, KnownNetworks.XelsMain));
        ...
        {
            Block block = Block.Load(Encoders.Hex.DecodeData(this.testBlockHex), KnownNetworks.XelsMain);
