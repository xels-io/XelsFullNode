...
namespace Xels.Bitcoin.Tests.BlockPulling
{
    public class BlockPullerTestsHelper
    {
        ...
        public Mock<INetworkPeer> CreatePeerMock(out ExtendedBlockPullerBehavior mockedBehavior, bool notSupportedVersion = false)
        {
            ...
            var connection = new NetworkPeerConnection(KnownNetworks.XelsMain, peer.Object, new TcpClient(), this.currentPeerId, (message, token) => Task.CompletedTask,
            ...
            VersionPayload version = connectionParameters.CreateVersion(new IPEndPoint(1, 1), new IPEndPoint(1, 1), KnownNetworks.XelsMain, new DateTimeProvider().GetTimeOffset());
