...
namespace Xels.Bitcoin.Tests.Consensus
{
    public class CheckPointsTest
    {
        ...
        {
            var checkpoints = new Checkpoints(KnownNetworks.TestNet, new ConsensusSettings(NodeSettings.Default(KnownNetworks.XelsTest)) { UseCheckpoints = true });
        ...
        {
            var checkpoints = new Checkpoints(KnownNetworks.RegTest, new ConsensusSettings(NodeSettings.Default(KnownNetworks.XelsTest)) { UseCheckpoints = true });
        ...
        //[Fact]
        //public void GetLastCheckPointHeight_XelsMainnet_ReturnsLastCheckPointHeight()
        //{
        //    var checkpoints = new Checkpoints(KnownNetworks.XelsMain, new ConsensusSettings(NodeSettings.Default(KnownNetworks.XelsTest)) { UseCheckpoints = true });
        ...
        //[Fact]
        //public void GetLastCheckPointHeight_XelsTestnet_ReturnsLastCheckPointHeight()
        //{
        //    var checkpoints = new Checkpoints(KnownNetworks.XelsTest, new ConsensusSettings(NodeSettings.Default(KnownNetworks.XelsTest)) { UseCheckpoints = true });
        ...
        {
            var checkpoints = new Checkpoints(KnownNetworks.XelsRegTest, new ConsensusSettings(NodeSettings.Default(KnownNetworks.XelsTest)) { UseCheckpoints = true });
        ...
        //[Fact]
        //public void VerifyCheckpoints_XelsMainnet()
        //{
        //    var verifyableCheckpoints = new Dictionary<int, CheckpointInfo>
        //    {
        ...
        //[Fact]
        //public void VerifyCheckpoints_XelsTestnet()
        //{
        //    var verifyableCheckpoints = new Dictionary<int, CheckpointInfo>
        //    {
