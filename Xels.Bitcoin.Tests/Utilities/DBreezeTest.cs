...
namespace Xels.Bitcoin.Tests.Utilities
{
    ...
    public class DBreezeTest : TestBase
    {
        ...
        /// </summary>
        public DBreezeTest() : base(KnownNetworks.XelsRegTest)
        {
        ...
        {
            Block block = KnownNetworks.XelsRegTest.Consensus.ConsensusFactory.CreateBlock();
        ...
        public void DeserializerWithCoinsDeserializesObject()
        {
            ...
            var result = (Coins)this.dbreezeSerializer.Deserialize(coins.ToBytes(KnownNetworks.XelsRegTest.Consensus.ConsensusFactory), typeof(Coins));
        ...
        public void DeserializerWithBlockHeaderDeserializesObject()
        {
            ...
            var result = (BlockHeader)this.dbreezeSerializer.Deserialize(blockHeader.ToBytes(KnownNetworks.XelsRegTest.Consensus.ConsensusFactory), typeof(BlockHeader));
        ...
        public void DeserializerWithBlockDeserializesObject()
        {
            ...
            var result = (Block)this.dbreezeSerializer.Deserialize(block.ToBytes(KnownNetworks.XelsRegTest.Consensus.ConsensusFactory), typeof(Block));
