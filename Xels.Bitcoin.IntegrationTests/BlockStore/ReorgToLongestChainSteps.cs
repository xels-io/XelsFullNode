...
namespace Xels.Bitcoin.IntegrationTests.BlockStore
{
    public partial class ReorgToLongestChainSpecification
    {
        ...
        {
            this.bobNode = this.nodeBuilder.CreateXelsPowNode(this.network).AlwaysFlushBlocks().WithWallet().Start();
            this.charlieNode = this.nodeBuilder.CreateXelsPowNode(this.network).WithWallet().Start();
            this.daveNode = this.nodeBuilder.CreateXelsPowNode(this.network).WithWallet().Start();
            this.jingNode = this.nodeBuilder.CreateXelsPowNode(this.network).WithWallet().Start();
