...
namespace Xels.Bitcoin.IntegrationTests
{
    public class ProofOfStakeSteps
    {
        ...
        {
            this.PremineNodeWithCoins = this.nodeBuilder.CreateXelsPosNode(new XelsRegTest()).WithWallet().Start();
        }
        ...
        public void PremineNodeWithWalletWithOverrides()
        {
            ...
            this.PremineNodeWithCoins = this.nodeBuilder.CreateCustomNode(callback, new XelsRegTest(), ProtocolVersion.PROTOCOL_VERSION, configParameters: configParameters);
