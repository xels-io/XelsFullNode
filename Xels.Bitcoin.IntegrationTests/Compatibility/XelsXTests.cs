    ...
    public class XelsXTests
    {
        ...
        public void SBFNMinesBlocks_XSyncs()
        {
            ...
            using (NodeBuilder builder = NodeBuilder.Create(this))
            {
                ...
                TestHelper.WaitLoop(() => xelsNodeRpc.GetBlockCount() >= 10, cancellationToken: cancellationToken);
                TestHelper.WaitLoop(() => xelsNodeRpc.GetBestBlockHash() == xelsXRpc.GetBestBlockHash(), cancellationToken: cancellationToken);
            }
        }
        ...
        public void XMinesBlocks_SBFNSyncs()
        {
            ...
            using (NodeBuilder builder = NodeBuilder.Create(this).WithLogsEnabled())
            {
                ...
                TestHelper.WaitLoop(() => xelsXRpc.GetBlockCount() >= 10, cancellationToken: cancellationToken);
                TestHelper.WaitLoop(() => xelsXRpc.GetBestBlockHash() == xelsNodeRpc.GetBestBlockHash(), cancellationToken: cancellationToken);
            }
        }
        ...
        public void SBFNMinesTransaction_XSyncs()
        {
            ...
            using (NodeBuilder builder = NodeBuilder.Create(this))
            {
                ...
                TestHelper.WaitLoop(() => xelsNodeRpc.GetBestBlockHash() == xelsXRpc.GetBestBlockHash(), cancellationToken: longCancellationToken);
                ...
                TestHelper.WaitLoop(() => xelsNodeRpc.GetRawMempool().Length == 1, cancellationToken: shortCancellationToken);

                // Transaction should percolate through to X's mempool.
                TestHelper.WaitLoop(() => xelsXRpc.GetRawMempool().Length == 1, cancellationToken: shortCancellationToken);

                // Now SBFN must mine the block.
                TestHelper.MineBlocks(xelsNode, 1);

                // We expect that X will sync correctly.
                TestHelper.WaitLoop(() => xelsNodeRpc.GetBestBlockHash() == xelsXRpc.GetBestBlockHash(), cancellationToken: shortCancellationToken);

                // Sanity check - mempools should both become empty.
                TestHelper.WaitLoop(() => xelsNodeRpc.GetRawMempool().Length == 0, cancellationToken: shortCancellationToken);
                TestHelper.WaitLoop(() => xelsXRpc.GetRawMempool().Length == 0, cancellationToken: shortCancellationToken);
            }
        }
        ...
        public void XMinesTransaction_SBFNSyncs()
        {
            ...
            using (NodeBuilder builder = NodeBuilder.Create(this))
            {
                ...
                TestHelper.WaitLoop(() => xelsXRpc.GetBlockCount() >= 11, cancellationToken: shortCancellationToken);
                ...
                TestHelper.WaitLoop(() => xelsXRpc.GetBlockCount() >= 12, cancellationToken: shortCancellationToken);
