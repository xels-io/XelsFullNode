    ...
    public class XelsXTests
    {
        ...
        public void SBFNCreatesOpReturnTransaction_XSyncs()
        {
            ...
            using (NodeBuilder builder = NodeBuilder.Create(this))
            {
                ...
                xelsNode.FullNode.NodeController<WalletController>().SendTransaction(new SendTransactionRequest(transaction.ToHex()));
        ...
        {
            Network network = new XelsMain10KCheckpoint();
            ...
            using (NodeBuilder builder = NodeBuilder.Create(this).WithLogsEnabled())
            {
                CoreNode xelsXNode = builder.CreateMainnetXelsXNode()
                    .WithReadyBlockchainData(ReadyBlockchain.XelsXMainnet15K);
                ...
                gatewayParameters.Add("whitelist", xelsXNode.Endpoint.ToString());
                CoreNode gatewayNode =
                    builder.CreateXelsPosNode(network, configParameters: gatewayParameters, isGateway: true)
                    .WithReadyBlockchainData(ReadyBlockchain.XelsMainnet9500);
                ...
                gatewayNodeRpc.AddNode(xelsXNode.Endpoint);
