...
{
    /// <summary>
    /// Xels test fixture for RPC tests.
    /// </summary>
    public class RpcTestFixtureXels : RpcTestFixtureBase
    {
        /// <inheritdoc />
        protected override void InitializeFixture()
        {
            this.Builder = NodeBuilder.Create(this);
            this.Node = this.Builder.CreateXelsPowNode(new BitcoinRegTest()).Start();
    ...
    public class RpcTests : IClassFixture<RpcTestFixtureXels>
    {
        private readonly RpcTestFixtureXels rpcTestFixture;

        public RpcTests(RpcTestFixtureXels RpcTestFixture)
        {
        ...
        {
            PeerInfo[] peers = this.rpcTestFixture.RpcClient.GetXelsPeersInfoAsync().Result;
        ...
        //    {
        //        CoreNode nodeA = builder.CreateXelsPosNode();
        //        CoreNode nodeB = builder.CreateXelsPosNode();
        //        builder.StartAll();
        ...
        //    Key key = new Key();
        //    this.rpcTestFixture.RpcClient.ImportAddress(key.PubKey.GetAddress(XelsNetworks.XelsMain), accountName, false);
