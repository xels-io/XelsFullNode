...
namespace Xels.Bitcoin.IntegrationTests
{
    public class MinerTests
    {
        ...
        public void Miner_Create_Block_Whilst_Connected_Syncs()
        {
            using (NodeBuilder builder = NodeBuilder.Create(this))
            {
                CoreNode miner = builder.CreateXelsPowNode(KnownNetworks.RegTest).WithDummyWallet().Start();
                CoreNode syncer = builder.CreateXelsPowNode(KnownNetworks.RegTest).Start();
