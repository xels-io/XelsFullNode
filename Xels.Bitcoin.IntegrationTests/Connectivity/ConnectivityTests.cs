...
namespace Xels.Bitcoin.IntegrationTests.Connectivity
{
    public class ConnectivityTests
    {
        ...
        public void Ensure_Peer_CanDiscover_Address_From_ConnectedPeers_And_Connect_ToThem()
        {
            ...
            {
                CoreNode nodeGroupA_1 = builder.CreateXelsPowNode(this.powNetwork, "nodeGroupA_1").EnablePeerDiscovery().Start();
                CoreNode nodeGroupB_1 = builder.CreateXelsPowNode(this.powNetwork, "nodeGroupB_1").EnablePeerDiscovery().Start();
                CoreNode nodeGroupB_2 = builder.CreateXelsPowNode(this.powNetwork, "nodeGroupB_2").EnablePeerDiscovery().Start();
        ...
        public void When_Connecting_WithAddnode_Connect_ToPeer_AndAnyPeers_InTheAddressManager()
        {
            ...
            using (NodeBuilder builder = NodeBuilder.Create(this))
            {
                CoreNode node1 = builder.CreateXelsPosNode(this.posNetwork).Start();
                CoreNode node2 = builder.CreateXelsPosNode(this.posNetwork).Start();
                CoreNode node3 = builder.CreateXelsPosNode(this.posNetwork).Start();
                CoreNode syncerNode = builder.CreateXelsPosNode(this.posNetwork).Start();
