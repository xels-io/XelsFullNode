...
namespace Xels.Bitcoin.IntegrationTests
{
    public class CoinViewTests
    {
        ...
        public void CanHandleReorgs()
        {
            ...
            {
                CoreNode xelsNode = builder.CreateXelsPowNode(this.regTest).Start();
                ...
                ((CachedCoinView)xelsNode.FullNode.CoinView()).FlushAsync().Wait();
                ...
                TestHelper.WaitLoop(() => TestHelper.AreNodesSynced(xelsNode, coreNode2));
            }
        }
