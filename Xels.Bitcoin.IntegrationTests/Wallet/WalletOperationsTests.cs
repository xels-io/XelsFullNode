...
namespace Xels.Bitcoin.IntegrationTests.Wallet
{
    public class WalletOperationsFixture : IDisposable
    {
        ...
        public WalletOperationsFixture()
        {
            ...
            CoreNode xelsNode = this.builder.CreateXelsPosNode(this.network).Start();

            string walletsFolderPath = xelsNode.FullNode.DataFolder.WalletPath;
    ...
    public class WalletOperationsTests : IClassFixture<WalletOperationsFixture>
    {
        ...
        public async Task CreateWalletWithoutMnemonic()
        {
            ...
            wallet.GetAccountsByCoinType(CoinType.Xels).Should().ContainSingle();

            // Check the created account.
            HdAccount account = wallet.GetAccountsByCoinType(CoinType.Xels).Single();
            ...
            account.GetCoinType().Should().Be(CoinType.Xels);
        ...
        public async Task CheckBalancesInWallet()
        {
            ...
            accountBalance.CoinType.Should().Be(CoinType.Xels);
        ...
        public async Task FundsReceivedByAddress()
        {
            ...
            addressBalance.CoinType.Should().Be(CoinType.Xels);
        ...
        public async Task GetWalletGeneralInfo()
        {
            ...
            generalInfoModel.Network.Name.Should().Be(new XelsRegTest().Name);
