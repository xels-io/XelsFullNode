...
namespace Xels.Bitcoin.IntegrationTests.Wallet
{
    public partial class SendingToAndFromManyAddressesSpecification : BddSpecification
    {
        ...
        {
            this.firstNode = this.nodeBuilder.CreateXelsPowNode(new BitcoinRegTestOverrideCoinbaseMaturity(1)).WithWallet().Start();
            this.secondNode = this.nodeBuilder.CreateXelsPowNode(new BitcoinRegTestOverrideCoinbaseMaturity(1)).WithWallet().Start();
