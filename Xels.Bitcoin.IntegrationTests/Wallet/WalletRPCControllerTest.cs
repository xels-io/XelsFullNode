...
namespace Xels.Bitcoin.IntegrationTests.Wallet
{
    public class WalletRPCControllerTest
    {
        ...
        public void GetTransactionDoesntExistInWalletOrBlock()
        {
            ...
            {
                // Arrange.
                CoreNode node = builder.CreateXelsPosNode(this.network).WithReadyBlockchainData(ReadyBlockchain.XelsRegTest150Miner).Start();
        ...
        public async Task GetTransactionExistsInBlockButDoesntExistInWalletAsync()
        {
            ...
            {
                // Arrange.
                CoreNode node = builder.CreateXelsPosNode(this.network).WithReadyBlockchainData(ReadyBlockchain.XelsRegTest150Listener).Start();
