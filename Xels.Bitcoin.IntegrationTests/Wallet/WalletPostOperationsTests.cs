...
namespace Xels.Bitcoin.IntegrationTests.Wallet
{
    ...
    public class WalletPostOperationsTests
    {
        ...
        //        // Arrange.
        //        CoreNode node = builder.CreateXelsPosNode(this.network).Start();
        //        CoreNode miningNode = builder.CreateXelsPosNode(this.network).WithReadyBlockchainData(ReadyBlockchain.XelsRegTest150Miner).Start();
        ...
        //        CoreNode sendingNode = builder.CreateXelsPosNode(this.network).WithReadyBlockchainData(ReadyBlockchain.XelsRegTest150Miner).Start();
        //        CoreNode receivingNode = builder.CreateXelsPosNode(this.network).WithReadyBlockchainData(ReadyBlockchain.XelsRegTest150Listener).Start();
        ...
        //        // Arrange.
        //        // Create a sending and a receiving node.
        //        CoreNode node1 = builder.CreateXelsPosNode(this.network).WithReadyBlockchainData(ReadyBlockchain.XelsRegTest10Miner).Start();
        ...
        //        node1Balance.SpendableAmount.Should().Be(Money.Zero); // Maturity for XelsregTest is 10, so at block 10, no coin is spendable.
        ...
        //        node2Balance.SpendableAmount.Should().Be(new Money(98000396 - 40, MoneyUnit.BTC)); // Maturity for XelsregTest is 10, so at block 100, the coins in the last 10 blocks (10*4) are not spendable.
        //    }
        //}
