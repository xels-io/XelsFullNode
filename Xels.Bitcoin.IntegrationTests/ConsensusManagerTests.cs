...
namespace Xels.Bitcoin.IntegrationTests
{
    public class ConsensusManagerTests
    {
        ...
        public class XelsConsensusOptionsOverrideTest : XelsRegTest
        {
            public XelsConsensusOptionsOverrideTest()
            {
        ...
        private static Transaction CreateTransactionThatSpendCoinstake(XelsRegTest network, CoreNode minerA, CoreNode minerB, TxIn coinstake, Transaction txWithBigPremine)
        {
