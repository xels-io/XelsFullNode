...
namespace Xels.Bitcoin.Features.Miner.Tests
{
    public class PosBlockAssemblerTest : LogsTestBase
    {
        ...
        private readonly Network xelsTest;
        ...
        public void UpdateHeaders_UsingChainAndNetwork_PreparesStakeBlockHeaders()
        {
            this.ExecuteWithConsensusOptions(new PosConsensusOptions(), () =>
            {
                ...
                ConcurrentChain chain = GenerateChainWithHeight(5, this.xelsTest, new Key());

                this.stakeValidator.Setup(s => s.GetNextTargetRequired(this.stakeChain.Object, chain.Tip, this.xelsTest.Consensus, true))
                    .Returns(new Target(new uint256(1123123123)))
                    .Verifiable();

                var posBlockAssembler = new PosTestBlockAssembler(this.consensusManager.Object, this.xelsTest, new MempoolSchedulerLock(), this.mempool.Object, this.minerSettings, this.dateTimeProvider.Object, this.stakeChain.Object, this.stakeValidator.Object, this.LoggerFactory.Object);
        ...
        public void CreateNewBlock_WithScript_ReturnsBlockTemplate()
        {
            this.ExecuteWithConsensusOptions(new PosConsensusOptions(), () =>
            {
                ConcurrentChain chain = GenerateChainWithHeight(5, this.xelsTest, this.key);
                ...
                Transaction transaction = CreateTransaction(this.xelsTest, this.key, 5, new Money(400 * 1000 * 1000), new Key(), new uint256(124124));
                transaction.Time = Utils.DateTimeToUnixTime(datetime);
                var txFee = new Money(1000);

                SetupTxMempool(chain, this.xelsTest.Consensus.Options as PosConsensusOptions, txFee, transaction);

                this.stakeValidator.Setup(s => s.GetNextTargetRequired(this.stakeChain.Object, chain.Tip, this.xelsTest.Consensus, true))
                    .Returns(new Target(new uint256(1123123123)))
                    .Verifiable();

                var posBlockAssembler = new PosBlockDefinition(this.consensusManager.Object, this.dateTimeProvider.Object, this.LoggerFactory.Object, this.mempool.Object, new MempoolSchedulerLock(), this.minerSettings, this.xelsTest, this.stakeChain.Object, this.stakeValidator.Object);
        ...
        public void ComputeBlockVersion_UsingChainTipAndConsensus_NoBip9DeploymentActive_UpdatesHeightAndVersion()
        {
            this.ExecuteWithConsensusOptions(new PosConsensusOptions(), () =>
            {
                ...
                var posBlockAssembler = new PosTestBlockAssembler(this.consensusManager.Object, this.xelsTest, new MempoolSchedulerLock(), this.mempool.Object, this.minerSettings,
        ...
        public void ComputeBlockVersion_UsingChainTipAndConsensus_Bip9DeploymentActive_UpdatesHeightAndVersion()
        {
            ...
            try
            {
                ...
                ConcurrentChain chain = GenerateChainWithHeightAndActivatedBip9(5, this.xelsTest, new Key(), this.xelsTest.Consensus.BIP9Deployments[0]);
                this.SetupRulesEngine(chain);
        ...
        public void AddTransactions_TransactionNotInblock_AddsTransactionToBlock()
        {
            ...
            this.ExecuteWithConsensusOptions(newOptions, () =>
            {
                ...
                posBlockAssembler.CreateCoinBase(new ChainedHeader(this.xelsTest.GetGenesis().Header, this.xelsTest.GetGenesis().Header.GetHash(), 0), new KeyId().ScriptPubKey);
        ...
        private void SetupRulesEngine(ConcurrentChain chain)
        {
            ...
            var posConsensusRules = new PosConsensusRuleEngine(
                ...
                chain,
                new NodeDeployments(this.xelsTest, chain),
                new ConsensusSettings(new NodeSettings(this.xelsTest)),
                new Checkpoints(),
