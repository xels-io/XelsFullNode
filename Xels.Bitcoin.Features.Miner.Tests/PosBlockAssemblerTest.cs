    ...
    public class PosBlockAssemblerTest : LogsTestBase
    {
        ...
        public void UpdateHeaders_UsingChainAndNetwork_PreparesStakeBlockHeaders()
        {
            this.ExecuteWithConsensusOptions(new PosConsensusOptions(), () =>
            {
                ...
                ChainIndexer chainIndexer = GenerateChainWithHeight(5, this.xelsTest, new Key());

                this.stakeValidator.Setup(s => s.GetNextTargetRequired(this.stakeChain.Object, chainIndexer.Tip, this.xelsTest.Consensus, true))
        ...
        public void CreateNewBlock_WithScript_ReturnsBlockTemplate()
        {
            this.ExecuteWithConsensusOptions(new PosConsensusOptions(), () =>
            {
                ChainIndexer chainIndexer = GenerateChainWithHeight(5, this.xelsTest, this.key);
                ...
                SetupTxMempool(chainIndexer, this.xelsTest.Consensus.Options as PosConsensusOptions, txFee, transaction);
        ...
        private void SetupRulesEngine(ChainIndexer chainIndexer)
        {
            ...
            var posConsensusRules = new PosConsensusRuleEngine(
                ...
                chainIndexer,
                new NodeDeployments(this.xelsTest, chainIndexer),
