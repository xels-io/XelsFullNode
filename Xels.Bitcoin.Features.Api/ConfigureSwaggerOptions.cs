...
namespace Xels.Bitcoin.Features.Api
{
    ...
    {
        private const string ApiXmlFilename = "Xels.Bitcoin.Api.xml";
        private const string WalletXmlFilename = "Xels.Bitcoin.LightWallet.xml";
        ...
        static OpenApiInfo CreateInfoForApiVersion(ApiVersionDescription description)
        {
            var info = new OpenApiInfo()
            {
                ...
                Description = "Access to the Xels Node's core features."
            };
