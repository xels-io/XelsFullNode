...
namespace Xels.Bitcoin.Features.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                setup.SwaggerDoc("v1", new Info { Title = "Xels.Bitcoin.Api", Version = "v1" });

                //Set the comments path for the swagger json and ui.
                string basePath = PlatformServices.Default.Application.ApplicationBasePath;
                string apiXmlPath = Path.Combine(basePath, "Xels.Bitcoin.Api.xml");
                string walletXmlPath = Path.Combine(basePath, "Xels.Bitcoin.LightWallet.xml");
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Xels.Bitcoin.Api V1");
            });
        }
    }
}