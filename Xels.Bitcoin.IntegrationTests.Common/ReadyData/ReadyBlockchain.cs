...
namespace Xels.Bitcoin.IntegrationTests.Common.ReadyData
{
    /// <summary>
    ...
    public class ReadyBlockchain
    {
        ...
        public static string XelsRegTestMinerAddress = "TXYdgqNVbHTfW5FsdxqSX6vejBByNEk2Yb";
        public static string BitcoinRegTestMinerAddress = "mgCHT7ABM88SGpgQGXmidU6dG3qb9qC4oa";

        public static string XelsRegTest10Miner = @"ReadyData/XelsRegTest10Miner.zip";
        public static string XelsRegTest10Listener = @"ReadyData/XelsRegTest10Listener.zip";
        public static string XelsRegTest10NoWallet = @"ReadyData/XelsRegTest10NoWallet.zip";

        public static string XelsRegTest100Miner = @"ReadyData/XelsRegTest100Miner.zip";
        public static string XelsRegTest100Listener = @"ReadyData/XelsRegTest100Listener.zip";
        public static string XelsRegTest100NoWallet = @"ReadyData/XelsRegTest100NoWallet.zip";

        public static string XelsRegTest150Miner = @"ReadyData/XelsRegTest150Miner.zip";
        public static string XelsRegTest150Listener = @"ReadyData/XelsRegTest150Listener.zip";
        public static string XelsRegTest150NoWallet = @"ReadyData/XelsRegTest150NoWallet.zip";
