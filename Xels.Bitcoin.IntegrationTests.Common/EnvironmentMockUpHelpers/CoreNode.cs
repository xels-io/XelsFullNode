...
namespace Xels.Bitcoin.IntegrationTests.Common.EnvironmentMockUpHelpers
{
    public class CoreNode
    {
        ...
        public CoreNode Start()
        {
            ...
            if ((this.runner is BitcoinCoreRunner) || (this.runner is XelsXRunner))
        ...
        private void CreateConfigFile(NodeConfigParameters configParameters = null)
        {
            ...
            // The debug log is disabled in xelsX when printtoconsole is enabled.
            ...
            // insight into the xelsd process while it is running.
            if (this.runner is XelsXRunner)
            {
