...
namespace Xels.Bitcoin.Configuration.Settings
{
    ...
    {
        /// <summary>Number of seconds to keep misbehaving peers from reconnecting 
        /// (Default 24-hour ban).
        /// </summary>
        public const int DefaultMisbehavingBantimeSeconds = 1 * 60 * 60;
        public const int DefaultMisbehavingBantimeSecondsTestnet = 10 * 60;

        /// <summary>Maximum number of AgentPrefix characters to
        /// use in the Agent value.
        /// </summary>
