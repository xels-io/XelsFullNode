...
namespace Xels.Bitcoin.Configuration
{
    ...
    public class NodeSettings : IDisposable
    {
        ...
        public NodeSettings(Network network = null, ProtocolVersion protocolVersion = SupportedProtocolVersion,
            string agent = "XelsNode", string[] args = null, NetworksSelector networksSelector = null)
        {
            ...
            this.DataDirRoot = this.ConfigReader.GetOrDefault<string>("datadirroot", "XelsNode", this.Logger);
