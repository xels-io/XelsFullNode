...
namespace Xels.Features.FederatedPeg.IntegrationTests
{
    ...
    public class NodeInitialisationTests
    {
        ...
        public void SidechainUserStarts()
        {
            ...
            {
                CoreNode user = nodeBuilder.CreateSidechainNode(new XoySideChainStartsRegTest());
        ...
        public void MinerPairStarts()
        {
            ...
            {
                CoreNode main = nodeBuilder.CreateXelsPosNode(this.mainNetwork).WithWallet();
    ...
    internal class XoySingleCollateralRegTest : XoyRegTest
    {
        internal XoySingleCollateralRegTest()
        {
    ...
    internal class XoySideChainStartsRegTest : XoyRegTest
    {
        internal XoySideChainStartsRegTest()
        {
            this.Name = "XoySideChainStartsRegTest";
        }
    }
}
